...
extension UIView{
    ...
    public func xmg_addGradientLayer(colors:[CGColor]){
    ...
    public func xmg_addShadowLayer(shadowColor:UIColor = UIColor(red: 0, green: 0, blue: 0, alpha: 0.08),radius:CGFloat = 5){
    ...
    public func xmg_drawDottedLine(color:UIColor)->CAShapeLayer{
